...
//let Guestlist : string[] = ["asma's family","bano's family","amber's family"];
...
//let Guestlist : string[] = ["Asma","Bano","Amber"];
//for(let i=0; i<Guestlist.length; i++){
//  console.log("Dear miss." + Guestlist[i] + ',\n\n It is my pleasure to invite you in our party.\n\n Thankyou\n\n')
//}
...
//for(let i=0; i<Guestlist.length; i++)
//    console.log("Dear miss." + Guestlst[i] + ',\n\n It is my pleasure to invite you in our party.\n\n Thankyou\n\n')//
//}
...
//let Guestlist : string[] = ["Alia","Asma","Sana","Bano","Amber","Maryam"];
...
//Task42 Great Magicians: Start with a copy of your program from Exercise 39. Write a function called make_great() that modifies the array of magicians by adding the phrase the Great to each magician’s name. Call show_magicians() to see that the list has actually been modified.
