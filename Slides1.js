...
var message1 = "A person who never made a mistake never tried anything new";
console.log("".concat(famous_person, " once said, \"").concat(message1, "\""));
//Task 06
//Date = 20-02-2024
...
var favourite_number = 2;
var message2 = 'Here is my favourite number ' + favourite_number;
...
//Date = 20-02-2024
var names1 = ['Asma', 'Bushra', 'Erum', 'Farah', 'Shabana'];
...
var list = ['car', 'motorcycle', 'bus', 'ambulance', 'van', 'auto'];
...
var Guestlist3 = ["Asma", "Bano", "Amber"];
...
var Guestlist4 = ["Alia", "Asma", "Sana", "Bano", "Amber", "Maryam"];
console.log("sorry,we cannot arrange a big table for dinner,only two person are invited.");
while (Guestlist4.length > 2) {
    var remove_Guest = Guestlist4.pop();
    console.log("\n sorry miss ".concat(remove_Guest, ", you are not invited for dinner,"));
}
...
var places = ['Makkah', 'Madina', 'Baghdad', 'Ajmer', 'palestine'];
...
var invited_guest = ["Amber", "Maryam"];
var count_invited_guest = invited_guest.length;
console.log("".concat(count_invited_guest, " guest will come to the dinner."));
...
var rivers_list = ["Indus river", "Hub river", "Kabul river", "Jehlum river"];
console.log("List of rivers:");
for (var i = 0; i < rivers_list.length; i++) {
...
//• Tests using the lower case function
//example 01
var person1 = "Faiz ahmed";
var person2 = "jawad ahmed";
...
//example 02
var childname1 = "bubloo";
var childname2 = "bubloo";
...
var subject = ["Urdu", "Islamiat", "Mathematics", "Science"];
